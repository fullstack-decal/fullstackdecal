...
To submit, push the files to a Github repository and submit on Gradescope. If you feel comfortable with creating Github repositories and no longer want to create a new one for each assignment, you can zip up the individual files and use the Upload File option on Gradescope!
