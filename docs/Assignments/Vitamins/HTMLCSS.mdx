...
should be empty. Add the boilerplate to your website. If you forgot how to do this, refer to the [HTML reading](/docs/Lessons/HTML).
...
[CSS reading](/docs/Lessons/CSSIntro).
