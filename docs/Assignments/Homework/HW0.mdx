...
3. Set up a GitHub account and create a GitHub repository
...
For this course, you will need both client-side and server-side JavaScript clients. You do not need to know what this means,
we will walk you through the necessary software.

- Version Control: Git
- Client-Side JavaScript: [Google Chrome]
...
## Part 2: Verifying git And Creating a GitHub Repository
...
If you don't already have git installed, download [git](https://git-scm.com/downloads). This should also download
