...
To submit, we will need to take an extra step. Navigate to the repository on GitHub. It will be inside the fa22-fullstack-decal organization.
Because it is part of this organization, it does not technically "belong" to you. In order to submit on Gradescope, you will need to *fork* it.
When you fork a repository, you are essentially creating another copy for yourself. In the upper right hand corner, you should see a `fork` button.
Click on this to create a fork. 
...
GitHub by searching all of your GitHub repositories. Find your repository, and submit the `main` branch. 
