...
1.  Open up Windows (On Mac it can be found under the applications folder ⇒
    ...
    ![Windows Image](../assets/Assign0/Assign0-0.png)
...
![Windows Image](../assets/Assign0/Assign0-6.png)
...
![Windows Image](../assets/Assign0/Assign0-1.png)
...
- you can also find your project url here:
  ![Windows Image](../assets/Assign0/Assign0-2.png)
