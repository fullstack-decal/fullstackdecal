...
[Homework 5](https://classroom.github.com/a/bEYzWDu3)
...
you must get checked off. You may get checked off at any TA office hour,
or you may come up after lecture to get checked off there. Homework is
*due* TBD, which means that you
must submit to Gradescope by then. You must then get checked off by the following
TBD.
