...
The starter code for this homework is available on GitHub Classroom. After cloning, run the below command to install the packages this app depends on!
```bash
npm install
```
...
What’s another feature of a social media site you think would be helpful if made a component?
