...
1. Provide a set of two flags that are right next to each other. Separate those two flags by 10px using margin.
2. Provide a flag with 2-3 elements. Shrink the flag by 60% using the padding.
