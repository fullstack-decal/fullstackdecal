...
- basic properties used by css: background-color, height, width
- flexbox of CSS
- margin/padding
- want to incorporate text (title, heading, subscripts)

## Setup
The starter code for this homework is here:

https://github.com/fullstack-decal/homework2-starter
...
Here is a nice resource for flexbox:
...
That's the end of this styling exercise! Now you should be familiar with some different flags and how CSS can cleverly transform simple HTML boxes into these different designs. Remember, you have a ton of flexibility with selecting elements and modifying them with an endless amount of properties that we have not covered - feel free to search them up!
