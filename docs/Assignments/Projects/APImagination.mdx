...
Let's combine these concepts to create a web application around a certain external API. Like mentioned before, there are countless APIs for pretty much whatever your mind can come up with, so we highly encourage you to spend some time thinking of cool ideas and seeing if there might be an external API online that can support that. If you do need some guidance, [here](/docs/Resources/APIReference)'s an external API reference resource that lists some cool and weird APIs alongside tutorials on how to use them, written by some of our course staff.
...
:::tip Project Ideas from Previous Semesters

Need some inspiration? Here are some cool project ideas from past students:

- **Project Timeline Planner** - A tool to plan and visualize project timelines with milestones and deadlines
- **Fantasy F1 Team Builder** - Build your dream Formula 1 team, track driver stats, and compete with friends
- **Stock Price Tracker** - Track stock prices in real-time, view historical data, and set price alerts
- **Skill Linker** - A platform where users can offer their skills and request sessions from others (like a skill-sharing marketplace)
- **Vibe Check** - A trending content and meme browsing app where users can take a "vibe quiz" to get personalized results, browse memes with likes and bookmarks, and share their vibe with friends
...
- NodeJS and NPM: You should have installed these during lecture- if you are not familiar with Node.js/NPM, please refer to [this reading](/docs/Lessons/Node) to get up to speed. Installing NodeJS should bring NPM with it: https://nodejs.org/en
...
Prerequisites: Make sure you have watched all lecture content or read all readings related to React and APIs. If you need to review, please refer to: [Introduction to React](/docs/Lessons/ReactIntro), [More React Hooks](/docs/Lessons/ReactHooks), [Routing & Axios](/docs/Lessons/Routing), [APIs and Client Side Rendering](/docs/Lessons/CSR).
...
For more information about what these frameworks are, feel free to checkout the [CSS Frameworks reading](/docs/Lessons/CSSFrameworks). Even though we haven't learned about them yet, you should have knowledge of all the tools necessary to use them, so go use them! Please never be stuck using base CSS, it seriously sucks.

### Backend

Prerequisites: Make sure you have watched all lecture content or read all readings related to: Node.js/NPM, Express.js, and Databases. If you need to review, please refer to: [Node.js + Package Managers](/docs/Lessons/Node), [SSR with Express.js, Cookies](/docs/Lessons/SSR), [Web Servers with Express.js](/docs/Lessons/Web), [Introduction to Databases](/docs/Lessons/DBIntro), [MongoDB](/docs/Lessons/Mongo), [SQL Databases](/docs/Lessons/SQL), [Object Relational Models](/docs/Lessons/ORM).
