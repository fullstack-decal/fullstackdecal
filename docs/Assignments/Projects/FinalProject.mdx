...
You will be working in a group of **2 people** to brainstorm, create, and
deliver a full stack project! Your project must include a **design**
component, a **frontend** component, and a **backend** component. This project
...
You will be able to choose someone that you want to work with through a group preference form that will be sent out as the project is released on Ed, and responses will be considered when assigning groups.
But please note that due to the size of the class there will still be a good chance that you will be working with people you don't know for this project, and after groups are assigned we will not be able to allow you to switch to another group.
...
This checkpoint is relatively simple: by now you should already be in assigned groups of 2 people depending on Group Preferences from the previous form and class size.
...
This will be worth **5% of the overall project grade**.
...
- Get your Figma mockup and system design write up checked off.

This will be worth **15% of the overall project grade**. All of your points for this part will come from a successful checkoff. So either you get full points (get checked off), or get no points (don't get checked off).
...
You must **deploy your website to Vercel** so it's live and accessible online. Check the deployment lecture slides for a step-by-step guide on how to do this.

### Submission

1. **Deploy your website to Vercel** and note your live URL
2. Upload your GitHub repository code to the "Project 3: Final Project [Implementation]" Gradescope assignment
3. **Submit your deployed website URL** to the "Project 3: Final Project [Link]" Gradescope assignment

:::warning Before submitting to GitHub
- DO NOT upload `node_modules/` - this folder is too large
- DO NOT upload sensitive information like API keys (use `.env` files and add them to `.gitignore`)

For more information about Git and GitHub, please refer to the [GitHub reading](/docs/Lessons/GitHub) or this [useful reference](https://rogerdudler.github.io/git-guide/).
:::
...
This project may seem a little bit scary at first, but you will have a lot of support from staff and feel completely free to come to OH to get any help during the course of this project.
