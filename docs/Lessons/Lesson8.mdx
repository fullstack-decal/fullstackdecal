...
As a refresher, cookies are a way of storing information that survives page refreshes.
...
Well, there are several fundamental differences you may have caught:
 ...
 2. Unless the client makes a request, the server (you) can't figure out how many views people have! The data is in people's browsers, not a file / database you control!
...
## Javascript - An important disambeguation
