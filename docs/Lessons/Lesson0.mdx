...
Before continuing, please look over the [syllabus](/syllabus) to
...
1. All materials are on this course website. This includes course readings,
   homework, and project specs.
2. All communications will happen on Ed. You will have access to the Ed if you are enrolled in the course.
3. Read through the [syllabus](/syllabus) for information on
