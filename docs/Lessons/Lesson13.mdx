...
# Lesson 13 - User Authentication with MongoDB
...
![Untitled](../assets/Lesson13/Lesson13-6.png)
...
![Lesson13-1](../assets/Lesson13/Lesson13-1.png)
...
![Lesson13-2](../assets/Lesson13/Lesson13-2.png)
...
- We will go through the above code line by line during lectures, but here are a
  ...
  - `const errors = validationResult(req);` is a function that the validator
    includes; it checks whether the request is a valid request.
...
![Lesson13-3](../assets/Lesson13/Lesson13-3.png)
...
![Lesson13-4](../assets/Lesson13/Lesson13-4.png)
...
![Untitled](../assets/Lesson13/Lesson13-4.png)
