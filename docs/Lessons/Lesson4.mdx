...
what's called _camel casing_, so-called because the capital letters in the
...
Variable can be called _almost_ anything. You **can't** use keywords. An example
...
One final thing to note is the use of _whitespacing_. In python, adding a new
...
should _always_ value readability over trying to get the least amount of lines
as possible.
