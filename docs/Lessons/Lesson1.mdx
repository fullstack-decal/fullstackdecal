...
## Welcome to [WDB](https://webatberkeley.org/)'s Introduction to Full-Stack Development DeCal!
...
Hey there! Web Dev is super difficult, it took me probably two years before I even understood what I was really doing. Don't be afraid to ask questions and just keep plodding forward. Trust in the process and it'll all make sense eventually!
...
**[Caelin Sutch](https://www.linkedin.com/in/caelinsutch) - Advisor**
...
**[Alex Wu](https://www.linkedin.com/in/jialin-wu-658929185/) - Advisor**
...
**[Samarth Goel](https://www.linkedin.com/in/samarth-goel-1047b8187/) - Facilitator**
...
**[Vicky Li](https://www.linkedin.com/in/victoriayli/) - Facilitator**
...
**[Abhi Wadekar](https://www.linkedin.com/in/abhiraam-wadekar/) - TA**

Hey everyone, I'm a junior studying CS and Environmental Science. Web development is an exciting and vast field, and I'm psyched to come with y'all on this ride! In my free time, I alternate between eating absurd amounts of hummus, getting involved in theatrical productions, and climbing things that shouldn't be climbed. Feel free to reach out anytime if you want to chat!

**[Kimberley Fan](https://www.linkedin.com/in/kimberleyfan/) - TA**
...
**[Dhruv Vaish](https://www.linkedin.com/in/dhruv-vaish/) - TA**
...
With all these factors in mind, we set out to create Web Development at Berkeley's education branch, a place where students with all sorts of backgrounds and experiences with web development and design could come together to learn these fundamental technologies while also learning about the tools used by professionals, to create meaningful projects that serve as opportunities to learn, and get the chance to gain real-world experience by transitioning to WDB's development branch, all in a no-pressure, supportive environment.
...
The course staff cares about one thing - making sure that you can learn and succeed in this course. Don't hesitate to contact us w any questions or comments as the course proceeds!
...
1. All materials are on this course website. This includes course plans, homework, and projects
2. All communications will happen on Slack. You will be invited to the slack workspace shortly, and if not, please click this link to join:
    - `#lecture-help`: will be the channel that you start in
    - `#homework-help`: will be the channel for all backend track people
    - `#homework-help`: will be the channel for all backend track people
3. Read through the [Course Policies](/course-policies) for information on grading, absence policies, and more. *This is incredibly important for you to understand how to succeed in this course*
...
If you want to learn more about this happy to chat, the development of the web is super interesting.
...
That being said, Edge, Safari, or  are all very, very good browsers with great dev tools too. If you feel comfortable with one of these already, stick with it. If you're using Safari, [make sure you enable dev tools](https://developer.apple.com/library/content/documentation/NetworkingInternetWeb/Conceptual/Web_Inspector_Tutorial/EnableWebInspector/EnableWebInspector.html).
