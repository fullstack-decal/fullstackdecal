...
Hey there! Full-Stack Development is super difficult, it took me probably two
years before I even understood what I was really doing. Don't be afraid to ask
questions and just keep plodding forward. Trust in the process and it'll all
...
get them with months of work, I guarantee you you'll have to work hard for them.

## Your TA's for this semester

**[Caelin Sutch](https://www.linkedin.com/in/caelinsutch) - Facilitator**

Hi everyone! My name is Caelin, and I'm a second year EECS and Business major
(though currently on a gap semester). There is nothing I love more than building
things, and web development is one of the easiest ways to quickly build and
iterate products. When I'm not programming, you'll find me DJing, listening to
music, and being a frat star.

**[Alex Wu](https://www.linkedin.com/in/jialin-wu-658929185/) - Full Stack TA**

Hi everyone! My name is Alex, and I am a third-year computer science major.
Besides web development, I love drawing prototypes on Figma and building
startups. In my free time, I practice magic & cardistry and play chess &
hearthstone.

**[Samarth Goel](https://www.linkedin.com/in/samarth-goel-1047b8187/) - Full
Stack TA**

Hey there! My name is Samarth and I'm majoring in CS and Business. Web
Development and Education are both huge passions of mine, which is why I'm so
excited to be helping with the Full-Stack DeCal. Besides coding, I practice
martial arts, play guitar, and play the drums in the cal band.

**[Vicky Li](https://www.linkedin.com/in/victoriayli/) - Design TA**

Hi everyone, I am a third-year Computer Science major. I first encountered the
wonderful world of web dev when cluelessly attending a hackathon and being
bombarded with a bunch of stuff I didn’t know. I believe it’s a super rewarding
and important topic that’s not extensively covered in Berkeley’s curriculum. I
especially love web design and making sites look sexy. Outside of coding and
staring at screens, I am an avid photographer and dancer. I enjoy making Youtube
videos in my free time, so as they say, like and subscribe, and go bears!

**[Kimberley Fan](https://www.linkedin.com/in/kimberleyfan/) - Frontend TA**

Hi everyone! I'm Kimberley and I'm a sophomore studying computer science from
Walnut, California. I really like building websites from ground up and being
able to help other peers enjoy it too is fun to me. Besides web development, I'm
into aesthetic cafes, anime and kdrama, screaming, and retail therapy. Feel free
to hit me up for whatever!

**[Nitya Krishnakumar](https://fullstack-decal.netlify.app/staff) - Frontend
TA**

**[Dhruv Vaish](https://www.linkedin.com/in/dhruv-vaish/) - Backend TA**

Hi y'all! My name is Dhruv and I'm an EECS + BioE major from Santa Clarita, CA.
I love anything about smart software design and organization and accessibility,
in my case accessibility in healthcare. In my free time, I like to watch
Netflix, listen to music, eat, and take adventures on the BART. See you all
soon!

**[Waleed Latif](https://www.linkedin.com/in/waleedlatif/) - Backend TA**

Hi! My name's Waleed Latif and I'm a Junior studying CompSci and CogSci. Web
Development has enabled me to build any app or website completely from scratch,
and we hope to enable you to do that as well! My interests include neuroscience,
snowboarding, and fashion. Looking forward to getting to know the students this
semester!

**[Isabel Zheng](https://www.linkedin.com/in/isabel-zheng-24003b1b2/) - Design
TA**

Hi all! I’m Isabel, a 2nd year Data Science major from LA. I love all things out
of the box and empathetic, especially within tech. Outside of web development,
you can find me watching astronomy videos, cafe hopping (peep the cafe pic), and
listening to Ichika Nito.
...
Before continuing, please look over the [Course Policies](/course-policies) to
...
2. All communications will happen on Slack. You will be invited to the slack
   workspace if you are enrolled in the course.
3. Read through the [Course Policies](/course-policies) for information on
...
put together to make a house. This is the HTML, or hypertext markup langauge.
...
Blockchain. feel free to google more abou tit.
...
When I fist started programming, each browser handled CSS very differently. As
such, we'd have different logic for different browsers, a complete pain in the
ass.
...
If you want to learn more about this I'm happy to chat, the development of the
web is super interesting.
...
around the instructionset for the browser to run your code. Pretty neat!
...
code, learning about HTTP and how to spinup your first Backend server.
...
Finally, we'll move to UI/UX principles. UI/UX stands for User Interface and
...
IMO this is the best part about Web Development, a final product that you can
show off to friends and lives permanently on the internet!
...
as [cmder](http://cmder.net/). If you're on Linux, I'd say just use whatever the
...
install in order to use. Along with that, you'll be using Github and Github
pages to hold and showcase your homework, so you'll need to set up an account
there. For the sake of time, we've decided to make setup and installation the
first homework of the semester so that you have time to download everything you
need and make sure it works without any pressure. Even if you think that you've
already downloaded web development software in the past, please look through and
complete the first homework in case we cover something you don't have.
