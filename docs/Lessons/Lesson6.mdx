...
Our javascript lessons teaches Vanilla JS. When you learn a framework such as
React, you won’t actually be needing to use Vanilla JS DOM manipulation that
...
find job interviewers asking you to code in 100% vanilla javascript sometimes
too!
