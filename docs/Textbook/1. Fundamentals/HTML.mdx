...
You can think of HTML as an outline. You outline the sections that you want, and then you fill them with the desired content. 
We can control exactly what our HTML document to look like and we do this with _tags_.
...
2. It gives the content in that section certain features, 
defining the most fundamental ways that a user can interact with a website.
...
calls to content in the body to style and functionalize respectively. 