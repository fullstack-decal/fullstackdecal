...
Similar to Homework 5, we will be implementing a **check-off** for this homework. The code will be due next 
Monday, November 14, 2022 at 11:59 PM PST. You will then have to get checked off by a staff member in any OH or HWP. 
You will need to complete the checkoff by Monday, November 21, 2022. 
