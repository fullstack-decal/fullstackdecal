...
1. You must go the the following link, and accept the assignment: [HW 0 Starter Code](https://classroom.github.com/a/qiYJsmsT)
...
Select `Authorized OAuth Apps > Gradescope`.  Under permissions, look for `fullstack-decal-sp23`. 
...
GitHub by searching all of your GitHub repositories. Find your repository under `fullstack-decal-sp23/hw0-[username]`, 
