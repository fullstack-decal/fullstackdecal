const staff = [
  ...
  {
    name: 'Hector Ramos',
    image: '/img/past-staff/hector.png',
  ...
  {
    name: 'Brian Holt',
    image: '/img/past-staff/brian.png',
