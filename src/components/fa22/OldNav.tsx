    ...
    <Box className="navbar navbar--fixed-top">
      <Box className="navbar__inner">
        <Box className="navbar__items">
          ...
          <a className="navbar__brand" href="/fa22">
            ...
            <b className="navbar__title">Full Stack Decal Fall 2022</b>
          </a>
          <a className="navbar__item navbar__link" href="/fa22/Syllabus">
            Syllabus
          </a>
          <a className="navbar__item navbar__link" href="/fa22/staff">
            Staff
          </a>
          <a className="navbar__item navbar__link" href="/fa22/resources">
            Resources
          </a>
        </Box>
      </Box>
