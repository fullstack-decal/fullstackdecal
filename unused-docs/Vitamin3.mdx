...
Just using `width` may not be enough to guarantee that the sidebar does not shrink below 100px.
Make sure that the sidebar is actually 100px. Is there a flex property you can use to prevent
it from shrinking?
:::
